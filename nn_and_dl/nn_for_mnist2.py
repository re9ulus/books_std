...
class Network:
    ...
    def update_mini_batch(self, mini_batch, eta, lmbda, n):
        ...
        for x, y in mini_batch:
            ...
            nabla_b = [db+dnb for db, dnb in zip(nabla_b, delta_nabla_b)]
            nabla_w = [dw+dnw for dw, dnw in zip(nabla_w, delta_nabla_w)]
    ...
    def backprop(self, x, y):
        ...
        #  backward pass
        delta = self.cost.deltaz(zs[-1], activations[-1], y)
        nabla_b[-1]  = delta
    ...
    def total_cost(self, data, lmbda, convert=False):
        ...
        cost += 0.5 * (lmbda/len(data)) * sum(np.linalg.norm(w)**w
